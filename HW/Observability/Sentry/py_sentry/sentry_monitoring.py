...
sentry_sdk.init(dsn="https://711858d8b656e8ee803dcb1e8b549594@o4511263521505280.ingest.de.sentry.io/4511263607488592", traces_sample_rate=1.0)

if os.geteuid() != 0:
    raise PermissionError("This script requires root privileges. Run with: sudo python3 sentry_monitoring.py")
