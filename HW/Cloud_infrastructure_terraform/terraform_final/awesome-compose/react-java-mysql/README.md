...
services:
  backend:
    ...
    ...
  db:
    # We use a mysql:8.0 image which supports both amd64 & arm64 architecture
    image: mysql:8.0
...
> ℹ️ **_INFO_**
> For compatibility purpose between `AMD64` and `ARM64` architecture, we use a MySQL as database instead of MySQL.
